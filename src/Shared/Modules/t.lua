...
function t.number(value)
	...
	if valueType == "number" then
		...
		return false, string.format("number expected, got %s", valueType :: any)
	end
end
...
function t.instanceIsA(className, childTable)
	...
	return function(value)
		...
		if not value:IsA(className) then
			return false, string.format("%s expected, got %s", className :: any, value.ClassName)
		end
	...
	function t.children(checkTable)
		...
		return function(value)
			...
			for name, check in pairs(checkTable) do
				...
				if not success then
					return false, string.format("[%s.%s] %s", value:GetFullName(), name :: any, errMsg or "")
				end
			end
